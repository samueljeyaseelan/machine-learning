...
(tensorflow-dev) user@SAMJ-PC:~/sam/TensorFlow/KMEANS$ pwd
/home/user/sam/TensorFlow/KMEANS
(tensorflow-dev) user@SAMJ-PC:~/sam/TensorFlow/KMEANS$ ls
design.txt Input  kmeans.cpp  kmeans.hpp  kmeans.py  main.cpp  Makefile  readme.txt  utils.cpp  utils.hpp
(tensorflow-dev) user@SAMJ-PC:~/sam/TensorFlow/KMEANS$

(tensorflow-dev) user@SAMJ-PC:~/sam/TensorFlow/KMEANS$ cat Input/input0.txt
...
(tensorflow-dev) user@SAMJ-PC:~/sam/TensorFlow/KMEANS$ cat Input/input1.txt
...
(tensorflow-dev) user@SAMJ-PC:~/sam/TensorFlow/KMEANS$ make
g++ -c main.cpp
g++ -c utils.cpp
g++ -c kmeans.cpp
...
(tensorflow-dev) user@SAMJ-PC:~/sam/TensorFlow/KMEANS$ ./kmeans_app ./Input/input0.txt
[78.03846][344.55383][177.44286]
(tensorflow-dev) user@SAMJ-PC:~/sam/TensorFlow/KMEANS$ ./kmeans_app ./Input/input1.txt
[47.88182][291.97272][210.90001]
(tensorflow-dev) user@SAMJ-PC:~/sam/TensorFlow/KMEANS$ ./kmeans_app ./Input/input2.txt
[44.280956][184.73573][302.23334]
(tensorflow-dev) user@SAMJ-PC:~/sam/TensorFlow/KMEANS$ ./kmeans_app ./Input/input3.txt
[11.47][132.676][354.32498]
(tensorflow-dev) user@SAMJ-PC:~/sam/TensorFlow/KMEANS$ ./kmeans_app ./Input/input4.txt
[322.46155][109.86667][219.25555]

8) How to cleanup?

(tensorflow-dev) user@SAMJ-PC:~/sam/TensorFlow/KMEANS$ make clean
